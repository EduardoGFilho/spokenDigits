...
l_features = ("mel", "magnasco", "stft")
l_normalization = ("minmax", "maggie", "std_freq", "none")

for features_index in l_features:
    for normalization_index in l_normalization:

        #if D starts at 15, it gives me some error
        for D_index in range(1):
            for T_index in range(1):
